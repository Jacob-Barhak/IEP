...
Covariates = {};
Coefficients = { 'P01', 'P12', 'P21' };
InitialGuess = [ 0.2, 0.2, 0.2];
...
Studies(2) = struct ('Name', 'Study1', 'StudyLength', 1, 'MainProcess', 0, 'PopID', 1);
Studies(3) = struct ('Name', 'Study2', 'StudyLength', 1, 'MainProcess', 0, 'PopID', 1);
Studies(4) = struct ('Name', 'Study3', 'StudyLength', 1, 'MainProcess', 0, 'PopID', 1);
...
States(10) = struct ('Name', 'MainProcess', 'IsEvent', 0, 'IsSplit', 0, 'JoinerOfSplit', 0, 'PoolingData', [ 1 2 3 4; 0 0 0 0] );
...
Transitions(end+1) = struct ('StudyID',1,'From', 2, 'To', 4, 'Probability', 1-P12 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', []  , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',1,'From', 3, 'To', 2, 'Probability', P21 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', []  , 'RegFunctionType', []  );
%
Transitions(end+1) = struct ('StudyID',2,'From', 1, 'To', 0, 'Probability', 1000 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',2,'From', 1, 'To', 2, 'Probability', 200 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%
Transitions(end+1) = struct ('StudyID',3,'From', 1, 'To', 0, 'Probability', 10000 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',3,'From', 1, 'To', 3, 'Probability', 600 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', [] );
%
Transitions(end+1) = struct ('StudyID',4,'From', 3, 'To', 0, 'Probability', 10000 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',4,'From', 3, 'To', 4, 'Probability', 2800 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', [] );
