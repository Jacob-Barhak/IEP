...
Transitions(end+1) = struct ('StudyID',4,'From', 4, 'To', 3, 'Probability', 225 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', [] );
%
Transitions(end+1) = struct ('StudyID',5,'From', 1, 'To', 0, 'Probability', 10000 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',5,'From', 1, 'To', 5, 'Probability', 3273.6 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', [] );
