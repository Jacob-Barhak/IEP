...
Studies(4) = struct ('Name', 'Study3', 'StudyLength', 2, 'MainProcess', 0, 'PopID', 1);
...
Transitions(end+1) = struct ('StudyID',2,'From', 1, 'To', 2, 'Probability', 360 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%
Transitions(end+1) = struct ('StudyID',3,'From', 1, 'To', 0, 'Probability', 10000 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',3,'From', 1, 'To', 3, 'Probability', 1080 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', [] );
%
Transitions(end+1) = struct ('StudyID',4,'From', 3, 'To', 0, 'Probability', 10000 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',4,'From', 3, 'To', 4, 'Probability', 4816 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', [] );
