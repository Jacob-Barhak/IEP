...
TableObservedCount2 = struct('Data',[20 82 152 269 399;54 115 237 373 580],'Dim',[Gender,NaN,0,1,Time,NaN,2,4,6,8,10]);
TableStartPopulation4 = struct('Data',[163 ; 312],'Dim',[Gender,NaN,0,1]);
TableObservedCount4 = struct('Data',[37 ; 48],'Dim',[Gender,NaN,0,1,Time,NaN,1]);
TableObservedCount5 = struct('Data',[13;20;33],'Dim',[Time,NaN,1,2,5]);
TableStartPopulation8 = struct('Data',[181 ; 287],'Dim',[Gender,NaN,0,1]);
TableObservedCount8 = struct('Data',[58 ; 79],'Dim',[Gender,NaN,0,1,Time,NaN,5]);
...
%Study3
Transitions(end+1) = struct ('StudyID',4,'From', 1, 'To', 0, 'Probability', 4540 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',4,'From', 1, 'To', 4, 'Probability', 901.596644864313 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%Study4
...
%Study6
Transitions(end+1) = struct ('StudyID',7,'From', 3, 'To', 0, 'Probability', 475 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',7,'From', 3, 'To', 5, 'Probability', 118.75 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%Study7
Transitions(end+1) = struct ('StudyID',8,'From', 4, 'To', 0, 'Probability', 73 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',8,'From', 4, 'To', 3, 'Probability', 6.7388965376 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%Study8
...
%Study10
Transitions(end+1) = struct ('StudyID',11,'From', 4, 'To', 0, 'Probability', 468 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',11,'From', 4, 'To', 5, 'Probability', 55.6472155078125 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
