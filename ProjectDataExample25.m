...
%Study3
Transitions(end+1) = struct ('StudyID',4,'From', 1, 'To', 4, 'Probability', [] ,'RegCoefVec', [ 0.039976699531183827221152816655145, 1.059, 0.525, 0.39, 1.35, 1.088, 1.078 ] ,'RegParamVec', [1, Age-55, 1-Gender, 1-Race, Smoke, (SBP-135.7)/10 , 10] , 'CovarianceMatrix', eye(7) , 'RegFunctionType', 3  );
%Study4
