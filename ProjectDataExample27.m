...
Coefficients = { 'P01','P02m','P02f','P12','P14','P23m','P23f','P32','P34m','P34f'};
InitialGuess = [  0.05,0.032, 0.032, 0.05, 0.05, 0.05, 0.05, 0.09, 0.07, 0.07];
...
% Define Tables
CoefficientTableP02 = struct('Data',[P02f ; P02m],'Dim',[Gender,NaN,0,1]);
...
CoefficientTableP34 = struct('Data',[P34f ; P34m],'Dim',[Gender,NaN,0,1]);
TableStartPopulation2 = struct('Data',[1897; 2643],'Dim',[Gender,NaN,0,1]);
TableObservedCount2 = struct('Data',[65.73105 128.75690212 189.013327191458 246.48247219871 301.182029208623 ; 145.57644 281.607759504 408.487362202886 526.64524635182 636.532322647806],'Dim',[Gender,NaN,0,1,Time,NaN,2,4,6,8,10]);
...
TableObservedCount5 = struct('Data',[1.46; 2.8616; 6.7392399889125],'Dim',[Time,NaN,1,2,5]);
TableStartPopulation8 = struct('Data',[181 ; 287],'Dim',[Gender,NaN,0,1]);
TableObservedCount8 = struct('Data',[18.2233771439173 ; 39.2703173684648],'Dim',[Gender,NaN,0,1,Time,NaN,5]);
...
Transitions(end+1) = struct ('StudyID',1,'From', 1, 'To', 3, 'Probability', CoefficientTableP02 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
...
Transitions(end+1) = struct ('StudyID',1,'From', 4, 'To', 5, 'Probability', CoefficientTableP34 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%Study1
Transitions(end+1) = struct ('StudyID',2,'From', 1, 'To', 0, 'Probability', 1138 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',2,'From', 1, 'To', 2, 'Probability', 48.7397240645688 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%Study2
Transitions(end+1) = struct ('StudyID',3,'From', 1, 'To', 0, 'Probability', 890 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',3,'From', 1, 'To', 3, 'Probability', 171.715684534946 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%Study3
...
Transitions(end+1) = struct ('StudyID',6,'From', 2, 'To', 5, 'Probability', 68.1078775 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%Study6
...
Transitions(end+1) = struct ('StudyID',9,'From', 4, 'To', 3, 'Probability', 21.005307401201 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%Study9
Transitions(end+1) = struct ('StudyID',10,'From', 4, 'To', 0, 'Probability', 78 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',10,'From', 4, 'To', 3, 'Probability', 7.200831768975 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%Study10
