...
Transitions(end+1) = struct ('StudyID',2,'From', 1, 'To', 3, 'Probability', 108 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%
...
Transitions(end+1) = struct ('StudyID',4,'From', 1, 'To', 5, 'Probability', 3168 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', [] );
