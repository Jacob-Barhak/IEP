...
%
Transitions(end+1) = struct ('StudyID',2,'From', 1, 'To', 2, 'Probability', [] ,'RegCoefVec', [0.1 0.2 0.005] ,'RegParamVec', StudyLengthConst*[1 Gender BP] , 'CovarianceMatrix', eye(3) , 'RegFunctionType', 11  );
