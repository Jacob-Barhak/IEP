...
TableStartPopulation = struct('Data',[90;100],'Dim',[Gender,NaN,0,1]);
TableObservedCount = struct('Data',[30;20],'Dim',[Gender,NaN,0,1,Time,NaN,3]);
...
%
Transitions(end+1) = struct ('StudyID',2,'From', 1, 'To', 0, 'Probability', TableStartPopulation ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',2,'From', 1, 'To', 2, 'Probability', TableObservedCount ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
