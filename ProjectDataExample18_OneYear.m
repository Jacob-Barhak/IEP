...
Transitions(end+1) = struct ('StudyID',2,'From', 1, 'To', 3, 'Probability', 60 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
%
...
%
Transitions(end+1) = struct ('StudyID',4,'From', 1, 'To', 0, 'Probability', 10000 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', []  );
Transitions(end+1) = struct ('StudyID',4,'From', 1, 'To', 5, 'Probability', 1760 ,'RegCoefVec', [] ,'RegParamVec', [] , 'CovarianceMatrix', [] , 'RegFunctionType', [] );
